...
/*
 *Task1VerifyElementIsPresent Three
 ...
 * 
 */
public class Task3ClickHoldBuild extends CommonMethods {
	...
	public static void main(String[] args) {
		...
		action.moveToElement(one).clickAndHold().moveToElement(two).clickAndHold().moveToElement(three).
		clickAndHold().moveToElement(four).build().perform();
	}
